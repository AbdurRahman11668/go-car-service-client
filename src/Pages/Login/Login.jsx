    ...
    <div>
      ...
      <div className="mx-10 mt-10 px-10 md:px-0 border-2 lg:max-w-2xl rounded-md lg:mx-auto border-[#df3437] mb-10">
        <div className=" mb-10">
          ...
          {LoginError && (
            <p className="text-[#df3437] text-center my-3">{LoginError}</p>
          )}
          {success && (
            <p className="text-[#df3437] text-center my-3">{success}</p>
          )}
          ...
          <div className="text-center">
            <p className="mt-5 mx-auto">
              <button onClick={handleGoogleSignIn} className="w-40">
                <img
